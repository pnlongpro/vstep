...
export function ClassDetailPage({ onBack, classData }: ClassDetailPageProps) {
  ...
  // Mock class data (sẽ dùng classData từ props sau)
  const classInfo = {
  ...
  const gradingSubmissions = [
    ...
    { id: 6, student: 'Lê Văn C', skill: 'speaking', assignment: 'Speaking Part 1 - Introduction', submittedDate: '18/12/2024 14:30', status: 'graded', taskType: 'Part 1', duration: '3:15', score: 7.0, grader: 'Trần Văn An', gradedDate: '19/12/2024 10:00' },
    { id: 7, student: 'Phạm Thị D', skill: 'writing', assignment: 'Essay Writing - Education System', submittedDate: '20/12/2024 16:00', status: 'pending', taskType: 'Task 2', wordCount: 295 },
    { id: 8, student: 'Hoàng Văn E', skill: 'speaking', assignment: 'Speaking Part 2 - Describe a person', submittedDate: '20/12/2024 11:30', status: 'pending', taskType: 'Part 2', duration: '2:30' },
    { id: 9, student: 'Nguyễn Thị F', skill: 'writing', assignment: 'Letter Writing - Informal Invitation', submittedDate: '19/12/2024 20:15', status: 'grading', taskType: 'Task 1', wordCount: 165, grader: 'Trần Văn An' },
    { id: 10, student: 'Trần Văn G', skill: 'speaking', assignment: 'Speaking Part 3 - Opinion', submittedDate: '18/12/2024 09:45', status: 'graded', taskType: 'Part 3', duration: '4:50', score: 6.5, grader: 'Nguyễn Thị Mai', gradedDate: '19/12/2024 08:30' },
    { id: 11, student: 'Lê Thị H', skill: 'writing', assignment: 'Essay Writing - Environment', submittedDate: '20/12/2024 13:20', status: 'pending', taskType: 'Task 2', wordCount: 302 },
    { id: 12, student: 'Phạm Văn I', skill: 'speaking', assignment: 'Speaking Part 1 - Hobbies', submittedDate: '20/12/2024 15:45', status: 'pending', taskType: 'Part 1', duration: '3:00' },
  ];
