import { CheckCircle2, XCircle, Trophy, Clock, Target, TrendingUp, RotateCcw, ArrowLeft } from 'lucide-react';
...
export function ReadingResult({ result, onTryAgain, onBackToList }: ReadingResultProps) {
      ...
      <div className={`bg-white rounded-2xl p-8 shadow-sm border-2 ${getScoreBgColor(vstepScore)}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-xl p-4 text-center">
            ...
            <div className="text-2xl text-blue-600">{percentage.toFixed(1)}%</div>
          ...
          <div className="bg-white rounded-xl p-4 text-center">
            ...
            <div className="text-2xl text-green-600">{exercise.level}</div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 border border-blue-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-lg p-4">
            ...
            <p className="text-xs text-gray-600">Reading {exercise.level} - MCQ</p>
          </div>
          <div className="bg-white rounded-lg p-4">
            <p className="text-sm mb-2">Nâng cao hơn</p>
            <p className="text-xs text-gray-600">
              Reading {exercise.level === 'B1' ? 'B2' : 'C1'} - Cloze Test
            </p>
          </div>
          <div className="bg-white rounded-lg p-4">
